...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/opengraph-image.png", // Generate a branded OG image!
        width: 1200,
        height: 630,
